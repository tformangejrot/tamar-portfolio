...
const openingDates = {
  'reformcore--shoreditch-london': { date: '2025-07-15', source: 'user_provided', notes: 'Estimated opening July 2025' },
};

// For locations that might need address matching
const addressMatches = {
  '10 Cygnet Street': { date: '2025-07-15', source: 'user_provided', notes: 'Estimated opening July 2025' },
};
...
async function main() {
  ...
  data.forEach(studio => {
    if (!/reformcore/i.test(studio.name)) return;
  ...
  console.log(`\n✓ Updated ${updated} Reformcore locations`);
